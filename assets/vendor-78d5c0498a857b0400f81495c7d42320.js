...
O(n)}return i}}throw new Error("illegal catch attempt")},delegateYield:function(e,t,n){return this.delegate={iterator:T(e),resultName:t,nextLoc:n},p}}}function h(e,n,r,i){var o=n&&n.prototype instanceof v?n:v,a=Object.create(o.prototype),s=new R(i||[])
...
default:return f.clientBuilder.bind(null)}}}),e.injection("service:-dom-builder","bootOptions","-environment:main"),e.injection("renderer","builder","service:-dom-builder"),e.register((0,E.privatize)(M||(M=(0,t.taggedTemplateLiteralLoose)(["template:-root"]))),F),e.injection("renderer","rootTemplate",(0,E.privatize)(I||(I=(0,t.taggedTemplateLiteralLoose)(["template:-root"])))),e.register("renderer:-dom",kn),e.register("renderer:-inert",Tn),e.injection("renderer","document","service:-document")},e._registerMacros=function(e){hn.push(e)},e.setComponentManager=function(e,t){var n
...
e.SafeString=ge
var be={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#x27;","`":"&#x60;","=":"&#x3D;"},ye=/[&<>"'`=]/,_e=/[&<>"'`=]/g
function we(e){return be[e]}function Ee(e){return null==e?e="":"string"!=typeof e&&(e=String(e)),new ge(e)}function Oe(e){return null!==e&&"object"==typeof e&&"function"==typeof e.toHTML}var Re=function(){function e(e){this.resolver=e}var t=e.prototype
...
return(0,c.createComputeRef)((function(){var e=t[0],n=t[1],r=t[2]
return!0===(0,R.toBool)((0,c.valueForRef)(e))?void 0!==r?(0,c.valueForRef)(r):void 0:(0,c.valueForRef)(n)}),null,"unless")},"-hash":Dt,"-each-in":function(e){var t=e.positional.at(0)
...
if(null===a.component?y.ENV._TEMPLATE_ONLY_GLIMMER_COMPONENTS&&(l=new Ct(o,r)):(0,k.isTemplateOnlyComponent)(a.component.class)&&(l=new Ct(o,r)),null!==a.component){var c=a.component.class,p=(0,f.getComponentManager)(n,c)
...
var u=this._runtimeResolver=new pn(e,n.isInteractive),l=new Re(u),c=(0,S.artifacts)();(function(e){var t=e.inlines,n=e.blocks
...
return i.appendOutletView=function(e,r){var i=function(e){if(y.ENV._APPLICATION_TEMPLATE_WRAPPER){var r=(0,n.assign)({},ke,{dynamicTag:!0,elementHook:!0,wrapped:!0}),i=new(function(e){function n(){return e.apply(this,arguments)||this}(0,t.inheritsLoose)(n,e)
var i=n.prototype
...
Array.isArray(e)?W(e,t,n,r):e.replace(t,n,r)},e.replaceInNativeArray=W,e.addArrayObserver=function(e,t,n){return Q(e,t,n,m,!1)},e.removeArrayObserver=function(e,t,n){return Q(e,t,n,v,!0)},e.arrayContentWillChange=H,e.arrayContentDidChange=q,e.eachProxyArrayWillChange=function(e,t,n,r){var i=Fe.get(e)
...
null!==s&&(s.isPrototypeMeta(e)||s.isInitializing())||S(e,a,o),v(e,a,r,i)}function R(e,t){var n=!0===t?_:w
...
var k=!1,P=[]
function S(e,t,n){if(void 0===n&&(n=!1),!0!==k){var r=!0===n?_:w,i=r.get(e)
if(void 0!==i){var o=i.get(t)
o.count--,0===o.count&&(i.delete(t),0===i.size&&r.delete(e))}}else P.push([e,t,n])}function x(e){w.has(e)&&w.get(e).forEach((function(t){t.tag=Z(e,t.path,(0,u.tagMetaFor)(e),(0,n.peekMeta)(e)),t.lastRevision=(0,u.valueForTag)(t.tag)})),_.has(e)&&_.get(e).forEach((function(t){t.tag=Z(e,t.path,(0,u.tagMetaFor)(e),(0,n.peekMeta)(e)),t.lastRevision=(0,u.valueForTag)(t.tag)}))}var A=0
...
null!==o&&(o.isInitializing()||o.isPrototypeMeta(e))||(L(e,t),F<=0&&C(),D in e&&(4===arguments.length?e[D](t,i):e[D](t)))}function U(){F++,k=!0}function z(){--F<=0&&(C(),function(){k=!1
for(var e,n=(0,t.createForOfIteratorHelperLoose)(P);!(e=n()).done;){var r=e.value
S(r[0],r[1],r[2])}P=[]}())}function V(e){U()
...
return void 0!==l&&(0,u.validateTag)(s,l)||((0,u.updateTag)(s,Z(e,this.altKey,a,o)),o.setRevisionFor(t,(0,u.valueForTag)(s)),K(o,t,r)),(0,u.consumeTag)(s),r},i.set=function(e,t,n){return ke(e,this.altKey,n)},i.readOnly=function(){this.set=Le},i.oneWay=function(){this.set=De},r}(re)
function Le(e,t){throw new c.default("Cannot set read-only property '"+t+"' on object: "+(0,r.inspect)(e))}function De(e,t,n){return ve(e,t,null),ke(e,t,n)}var Fe=new WeakMap
...
O=E(O)
var R=b.type||(0,o.typeOf)(O),T=this.serializeQueryParam(O,w,R),k=a+":"+g,P={undecoratedDefaultValue:(0,r.get)(u,g),defaultValue:O,serializedDefaultValue:T,serializedValue:T,type:R,urlKey:w,prop:g,scopedPropertyName:k,controllerName:a,route:this,parts:_,values:null,scope:y}
...
e.NativeArray=P
var S,x=["length"]
P.keys().forEach((function(e){Array.prototype[e]&&x.push(e)})),e.NativeArray=P=(c=P).without.apply(c,x),e.A=S,a.ENV.EXTEND_PROTOTYPES.Array?(P.apply(Array.prototype,!0),e.A=S=function(e){return e||[]}):e.A=S=function(e){return e||(e=[]),T.detect(e)?e:P.apply(e)}
var A=T
...
var r=R.get(e)
return void 0!==r&&R.set(n,r),n}var S=Object.prototype.toString,x=Function.prototype.toString,A=Array.isArray,C=Object.keys,N=JSON.stringify,j=100,M=/^[\w$]+$/
...
return E(this,t)}},camelize:{configurable:!0,enumerable:!1,writeable:!0,value:A("camelize",k)},decamelize:{configurable:!0,enumerable:!1,writeable:!0,value:A("decamelize",R)},dasherize:{configurable:!0,enumerable:!1,writeable:!0,value:A("dasherize",T)},underscore:{configurable:!0,enumerable:!1,writeable:!0,value:A("underscore",S)},classify:{configurable:!0,enumerable:!1,writeable:!0,value:A("classify",P)},capitalize:{configurable:!0,enumerable:!1,writeable:!0,value:A("capitalize",x)}})}}))
...
e.error({problem:i.op1.problem,span:{start:i.op1.start,end:i.op1.end}})}}function F(e,n){if(!M(n))if(Array.isArray(n))for(var i,o=(0,t.createForOfIteratorHelperLoose)(n);!(i=o()).done;){F(e,i.value)}else if("Number"===n.type)P(e.encoder,e.syntax.program.constants,n)
...
return R({args:function(){return{count:1,actions:[ae("Expr",e[0]),ae(70)]}},ifTrue:function(){return b(n.get("default"))},ifFalse:function(){return n.has("else")?b(n.get("else")):N}})})),e.add("unless",(function(e,t,n){if(!e||1!==e.length)throw new Error("SYNTAX ERROR: #unless requires a single argument")
return R({args:function(){return{count:1,actions:[ae("Expr",e[0]),ae(70)]}},ifTrue:function(){return n.has("else")?b(n.get("else")):N},ifFalse:function(){return b(n.get("default"))}})})),e.add("with",(function(e,t,r){if(!e||1!==e.length)throw new Error("SYNTAX ERROR: #with requires a single argument")
return R({args:function(){return{count:2,actions:[ae("Expr",e[0]),ae(32,n.$sp,0),ae(70)]}},ifTrue:function(){return y(r.get("default"),1)},ifFalse:function(){return r.has("else")?b(r.get("else")):N}})})),e.add("let",(function(e,t,n){if(!e)return oe("let requires arguments",0,0)
...
return new W(t.statements,ce(e),{symbols:t.symbols,hasEval:t.hasEval})}function J(e,t,n){for(var r=H,i=V(n,t),o=0;o<e.length;o++)F(i,r.compile(e[o],i.meta))
...
if(null!==o){var y=d.indexOf(pe);-1!==y&&(p.push(g(o)),h.push(y))}for(var _=0;_<b.length;_++){var w=b[_],E=d.indexOf("&"+w);-1!==E&&(p.push(g(c.get(w))),h.push(E))}if(t.createArgs){var O=le(a),R=O.count,T=O.actions
p.push(T)
var k=R<<4
k|=8
var P=r.EMPTY_ARRAY
if(null!==l){P=l[0]
for(var S=l[1],x=0;x<S.length;x++){var A=d.indexOf(P[x])
p.push(ae("Expr",S[x])),m.push(A)}}p.push(ae(82,s(P),s(r.EMPTY_ARRAY),k)),m.push(-1)}else if(null!==l)for(var C=l[0],N=l[1],j=0;j<N.length;j++){var M=C[j],I=d.indexOf(M);-1!==I&&(p.push(ae("Expr",N[j])),m.push(I),v.push(M))}p.push(ae(97,n.$s0)),t.dynamicScope&&p.push(ae(58)),t.createInstance&&p.push(ae(87,0|c.has("default"),n.$s0)),p.push(ae(88,n.$s0)),t.createArgs?p.push(ae(90,n.$s0)):p.push(ae(90,n.$s0,u(v))),p.push(ae(36,d.length+1,Object.keys(c).length>0?1:0),ae(19,0))
...
return new Ce(e,t)},e.isCurriedComponentDefinition=Ae,e.isWhitespace=function(e){return St.test(e)},e.normalizeProperty=k,e.runtimeContext=function(e,t,n,r){return{env:new Ut(e,t),program:new s.RuntimeProgramImpl(n.constants,n.heap),resolver:r}},e.inTransaction=zt,e.getDynamicVar=function(e,t){var n=t.dynamicScope(),r=e.positional.at(0)
...
0
return bn.set(t,e),t},e.templateOnlyComponent=function(e){return new _n(e)},e.isTemplateOnlyComponent=function(e){return e instanceof _n},e.getOwner=function(e){return e[wn]},e.setOwner=function(e,t){e[wn]=t},e.getComponentManager=function(e,t){var n=Mn(Pn,t)
if(void 0!==n){var r=In(e,n)
return r}return},e.setComponentManager=function(e,t){return jn(Pn,e,t)},e.getHelperManager=function(e,t){var n=Mn(xn,t)
if(void 0!==n){var r=In(e,n)
...
return new $(t,n)}(i,u,o)}function V(e,t,n){return D(e,t)?new G(n):new q(n)}var H=function(e){this.attribute=e}
...
var Pe=(0,n.symbol)("INNER"),Se=(0,n.symbol)("ARGS"),xe=new n._WeakSet
function Ae(e){return xe.has(e)}var Ce=function(e,t){xe.add(this),this[Pe]=e,this[Se]=t}
function Ne(e){var t=e[Pe],n=e[Se],r=n?n.positional.length:0
return Ae(t)?r+Ne(t):r}function je(e,t){var n=e
for(t.realloc(Ne(n));;){var r=n,i=r[Se],o=r[Pe]
...
e.loadValue(o.$v0,Fe(a,l,u,s))})),_e.add(77,(function(e,t){var n,r=t.op1,i=e.runtime.resolver.resolve(r),o=i.manager,a=Re(o.getCapabilities(i.state)),s=((n={})[ot]=!0,n.definition=i,n.manager=o,n.capabilities=a,n.state=null,n.handle=null,n.table=null,n.lookup=null,n)
...
Ae(i)?n=t=null:t=Re((n=i.manager).getCapabilities(i.state)),r.pushJs({definition:i,capabilities:t,manager:n,state:null,handle:null,table:null})})),_e.add(79,(function(e){var t,r=e.stack,o=(0,i.valueForRef)(r.popJs())
...
function mt(e){return function(e){return T(e)||E(e)||"boolean"==typeof e||"number"==typeof e}(e)?1:Ae(e)?0:O(e)?3:function(e){return R(e)&&11===e.nodeType}(e)?4:R(e)?5:1}function vt(e,t){console.info("Use `context`, and `get(<path>)` to debug this template."),t("this")}_e.add(75,(function(e){var t=e.stack.peek()
...
for(var E=Object.create(y.getPartialMap()),O=0;O<p.length;O++){var R=p[O],T=f[R-1],k=y.getSymbol(R)
E[T]=k}if(w)for(var P=0;P<b.length;P++){var S=P+1,x=w[b[P]]
...
var Pt,St=/[\t-\r \xA0\u1680\u180E\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]/,xt="undefined"==typeof document?null:document;(function(e){var n=function(e){function n(){return e.apply(this,arguments)||this}(0,t.inheritsLoose)(n,e)
var r=n.prototype
...
var r=n
r=kt(xt,r),r=Tt(xt,r,"http://www.w3.org/2000/svg"),e.DOMTreeConstruction=r})(Pt||(Pt={}))
...
var Pn=new WeakMap,Sn=new WeakMap,xn=new WeakMap,An=new WeakMap,Cn=new WeakMap,Nn=Object.getPrototypeOf
...
return D=F.pop()||null,f(e).combine()}function z(){F.push(D),D=null}function V(){D=F.pop()||null}function H(e){null!==D&&D.add(e)}var q=l("FN"),$=l("LAST_VALUE"),Y=l("TAG"),G=l("SNAPSHOT")
l("DEBUG_LABEL")
...
e=o[0],t=o[1],void 0===(r=o[2])?i=0:s(i=r.pop())||(n=!0===i,i=r.pop())}return[e,t,r,i=parseInt(i,10),n]}var w=0,E=0,O=0,R=0,T=0,k=0,P=0,S=0,x=0,A=0,C=0,N=0,j=0,M=0,I=0,L=0,D=0,F=0,B=0,U=0,z=0,V=function(){function e(e,t){var n=this
...
return!Object.isExtensible(e)||e.hasOwnProperty("attributes")?Object.freeze((0,t.assign)({},e,r)):(0,t.assign)(e,r)}function P(e){return null!=e&&void 0!==e.buildRouteInfoMetadata?e.buildRouteInfoMetadata():null}var S=function(){function e(e,t,n,r){this._routePromise=void 0,this._route=null,this.params={},this.isResolved=!1,this.name=t,this.paramNames=n,this.router=e,r&&this._processRoute(r)}var t=e.prototype
...
return r[n]=function(e,n){e?v(u,e):void 0===t?d(u,n):!0===t?d(u,P(arguments)):Array.isArray(t)?d(u,k(arguments,t)):d(u,n)},i?C(u,r,e,this):A(u,r,e,this)}
...
for(var be in a("instrument",!0),ge)ge.hasOwnProperty(be)&&me(be,ge[be])}var ye={asap:K,cast:de,Promise:T,EventTarget:i,all:N,allSettled:M,race:I,hash:D,hashSettled:B,rethrow:U,defer:z,denodeify:x,configure:a,on:me,off:ve,resolve:q,reject:$,map:H,async:he,filter:W}
...
m.pattern=RegExp(m.pattern.source,_+"g")}for(var w=m.pattern||m,E=s.next,O=c;E!==t.tail&&!(f&&O>=f.reach);O+=E.value.length,E=E.next){var R=E.value
if(t.length>e.length)return
if(!(R instanceof i)){var T,k=1
if(b){if(!(T=o(w,O,e,g)))break
var P=T.index,S=T.index+T[0].length,x=O
for(x+=E.value.length;P>=x;)x+=(E=E.next).value.length
if(O=x-=E.value.length,E.value instanceof i)continue
for(var A=E;A!==t.tail&&(x<S||"string"==typeof A.value);A=A.next)k++,x+=A.value.length
k--,R=e.slice(O,x),T.index-=O}else if(!(T=o(w,0,R,g)))continue
P=T.index
var C=T[0],N=R.slice(0,P),j=R.slice(P+C.length),M=O+R.length
f&&M>f.reach&&(f.reach=M)
var I=E.prev
N&&(I=u(t,I,N),O+=N.length),l(t,I,k),E=u(t,I,new i(p,v?r.tokenize(C,v):C,y,C)),j&&u(t,E,j),k>1&&a(e,t,n,E.prev,O,{cause:p+","+h,reach:M})}}}}}function s(){var e={value:null,prev:null,next:null},t={value:null,prev:e,next:null}
...
function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}Prism.languages.svg=Prism.languages.markup,Prism.languages.xml=Prism.languages.extend("markup",{}),Prism.languages.ssml=Prism.languages.xml,Prism.languages.atom=Prism.languages.xml,Prism.languages.rss=Prism.languages.xml,function(e){function t(e,t){return"___"+e.toUpperCase()+t+"___"}Object.defineProperties(e.languages["markup-templating"]={},{buildPlaceholders:{value:function(n,r,i,o){if(n.language===r){var a=n.tokenStack=[]
...
e.languages.css={comment:/\/\*[\s\S]*?\*\//,atrule:{pattern:/@[\w-](?:[^;{\s]|\s+(?![\s{]))*(?:;|(?=\s*\{))/,inside:{rule:/^@[\w-]+/,"selector-function-argument":{pattern:/(\bselector\s*\(\s*(?![\s)]))(?:[^()\s]|\s+(?![\s)])|\((?:[^()]|\([^()]*\))*\))+(?=\s*\))/,lookbehind:!0,alias:"selector"},keyword:{pattern:/(^|[^\w-])(?:and|not|only|or)(?![\w-])/,lookbehind:!0}}},url:{pattern:RegExp("\\burl\\((?:"+t.source+"|"+/(?:[^\\\r\n()"']|\\[\s\S])*/.source+")\\)","i"),greedy:!0,inside:{function:/^url/i,punctuation:/^\(|\)$/,string:{pattern:RegExp("^"+t.source+"$"),alias:"url"}}},selector:RegExp("[^{}\\s](?:[^{};\"'\\s]|\\s+(?![\\s{])|"+t.source+")*(?=\\s*\\{)"),string:{pattern:t,greedy:!0},property:/(?!\s)[-_a-z\xA0-\uFFFF](?:(?!\s)[-\w\xA0-\uFFFF])*(?=\s*:)/i,important:/!important\b/i,function:/[-a-z0-9]+(?=\()/i,punctuation:/[(){};:,]/},e.languages.css.atrule.inside.rest=e.languages.css
var n=e.languages.markup
n&&(n.tag.addInlined("style","css"),e.languages.insertBefore("inside","attr-value",{"style-attr":{pattern:/(^|["'\s])style\s*=\s*(?:"[^"]*"|'[^']*')/i,lookbehind:!0,inside:{"attr-value":{pattern:/=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+)/,inside:{style:{pattern:/(["'])[\s\S]+(?=["']$)/,lookbehind:!0,alias:"language-css",inside:e.languages.css},punctuation:[{pattern:/^=/,alias:"attr-equals"},/"|'/]}},"attr-name":/^style/i}}},n.tag))}(Prism),function(){var e=Object.assign||function(e,t){for(var n in t)t.hasOwnProperty(n)&&(e[n]=t[n])
return e}
...
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
e.default={"code-snippet-example.hbs":'{{! BEGIN-SNIPPET my-code-snippet }}\n<p><CodeSnippet @name="my-code-snippet.hbs" /></p>\n{{! END-SNIPPET }}',"customize-route.js":"import Route from '@ember/routing/route';\n\nexport default class DocsComponentsRoute extends Route {\n  order = Infinity;\n  title = 'Components';\n  disabled = true;\n}","dummy-application.hbs":'{{! tests/dummy/app/templates/application.hbs }}\n{{page-title "Dummy"}}\n\n<Navbar\n  @addonName="Dummy Addon"\n  @repo="https://github.com/concordnow/ember-concord-doc"\n/>\n\n{{outlet}}',"dummy-docs.hbs":'{{! tests/dummy/app/templates/docs.hbs }}\n{{page-title "Documentation"}}\n\n<div class="px-4 mx-auto lg:px-6 max-w-screen-2xl">\n  <div class="relative lg:flex">\n    <SidebarNav />\n\n    <article class="flex-1 w-full min-w-0 px-0 py-12 lg:px-4">\n      {{outlet}}\n    </article>\n  </div>\n</div>',"dummy-index.hbs":'{{! tests/dummy/app/templates/index.hbs }}\n<HeroHeader @addonName="Dummy Addon" />\n\n<div\n  class="px-4 py-10 max-w-3xl mx-auto sm:px-6 sm:py-12 lg:max-w-4xl lg:py-16 lg:px-8"\n>\n{{! MD-BLOCK }}\n# Describe your addon here\n\nLorem ipsum dolor sit amet, consectetur adipiscing elit. Donec suscipit\nelementum est ac posuere. Curabitur convallis iaculis dui, quis ultricies\nodio convallis a. Donec tincidunt massa sed neque imperdiet auctor. Sed\nvitae odio finibus libero accumsan sollicitudin. Donec posuere eros quis\nlibero eleifend condimentum. Donec consequat egestas rutrum. Quisque sed\ndolor eget odio ultricies mattis et sit amet nisl. Etiam maximus imperdiet\nconsequat. Suspendisse purus erat, porta sed bibendum ac, rutrum eu lacus.\nQuisque faucibus semper vehicula. In aliquam dolor eget purus feugiat, eget\nullamcorper sapien blandit. Phasellus ante metus, commodo non porttitor in,\nposuere eu orci. In vitae lacus non felis tempor eleifend. Aliquam erat\nvolutpat.\n{{! MD-BLOCK }}\n</div>\n',"hero-header-example.hbs":'<HeroHeader\n  @addonName="My custom Addon"\n/>',"my-code-snippet.hbs":'<p><CodeSnippet @name="my-code-snippet.hbs" /></p>',"navbar-example.hbs":'<Navbar\n  @addonName="My custom Addon"\n  @repo="https://github.com/concordnow/ember-custom-addon"\n/>',"sidebar-nav-example.hbs":"<SidebarNav />"}})),define("ember-concord-doc/components/code-snippet",["exports"],(function(e){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
